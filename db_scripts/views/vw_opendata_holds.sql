...
group by month_placed, placed_library, placed_authority, il.name, item_authority, pl.name, pickup_authority, reservation_method
order by month_placed, placed_library, placed_authority, il.name, item_authority, pl.name, pickup_authority, reservation_method;