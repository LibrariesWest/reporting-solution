...
select
    to_char(bp.payment_date, 'YYYY-MM-DD') as date_paid,
...
group by date_paid, payment_authority, payment_library, bill_reason, payment_type
order by date_paid, payment_authority, payment_library, bill_reason, payment_type;
