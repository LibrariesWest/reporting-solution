---------------------------------------------------------------
-- view: vw_dashboard_longtransits
---------------------------------------------------------------

-- drop view vw_dashboard_longtransits;
create or replace view vw_dashboard_longtransits as
select
...
where date_time_transited < now() - interval '3 months'
